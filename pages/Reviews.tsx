                ...
                <Link key={item.id} to={`/news/${item.id}`} className={`group border rounded-[2.5rem] overflow-hidden transition-all hover:-translate-y-2 shadow-2xl ${
                  ...
                  <div className="aspect-[16/10] relative overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6">
                       <span className="px-3 py-1.5 bg-black/60 backdrop-blur-xl text-[9px] font-black uppercase tracking-widest text-primary-blue border border-primary-blue/30 rounded-lg">{item.category}</span>
                    </div>
                  </div>
                  <div className="p-8">
